  ...
  workout: {
      ...
      phases: [
        {
          ...
          template: 'phase1',
          weekRules: [
            { weeks: [1, 2], sets: 2, earlyRPE: '~6-7', lastRPE: '~7', toFailure: false, note: 'Ease into the block — leave 2-3 reps in the tank and groove technique' },
            { weeks: [3, 4, 5], sets: 2, earlyRPE: '~7', lastRPE: '~7-8', toFailure: false, note: 'Same lifts, add load — push the last set closer to failure' },
          ],
        },
        {
          name: 'Ramping',
    ...
    recovery: {
      Upper: { focus: 'Strength Focus', exercises: [
        { name: '45° Incline Barbell Press', sub1: '45° Incline DB Press', sub2: '45° Incline Machine Press', reps: '6-8', rest: '3-5 min', warmupSets: 3, earlyRPE: { wk12: '~6', wk35: '~7' }, lastRPE: { wk12: '~7', wk35: '~7-8' }, toFailure: false, note: '1 second pause at the bottom of each rep while maintaining tension on the pecs.' },
        { name: 'Cable Crossover Ladder', sub1: 'Pec Deck', sub2: 'Bottom-Half DB Flye', reps: '8-10', rest: '1-2 min', warmupSets: 1, earlyRPE: { wk12: '~7', wk35: '~7' }, lastRPE: { wk12: '~7', wk35: '~8' }, toFailure: false, note: 'Do one set with a low cable position, one with medium, and one with a high cable position. If you only have one or two sets, pick the positions you prefer.' },
        { name: 'Wide-Grip Pull-Up', sub1: 'Wide-Grip Lat Pulldown', sub2: 'Dual-Handle Lat Pulldown', reps: '8-10', rest: '2-3 min', warmupSets: 2, earlyRPE: { wk12: '~6', wk35: '~7' }, lastRPE: { wk12: '~7', wk35: '~7' }, toFailure: false, note: '1.5x shoulder-width overhand grip. Slow 2-3 second negative. Feel your lats pulling apart on the way down.' },
        { name: 'High-Cable Lateral Raise', sub1: 'High-Cable Cuffed Lateral Raise', sub2: 'Lean-In DB Lateral Raise', reps: '8-10', rest: '1-2 min', warmupSets: 1, earlyRPE: { wk12: '~7', wk35: '~7' }, lastRPE: { wk12: '~7', wk35: '~8' }, toFailure: false, note: 'Focus on squeezing your lateral delt to move the weight.' },
        { name: 'Pendlay Deficit Row', sub1: 'Smith Machine Row', sub2: 'Single-Arm DB Row', reps: '6-8', rest: '2-3 min', warmupSets: 2, earlyRPE: { wk12: '~6', wk35: '~7' }, lastRPE: { wk12: '~7', wk35: '~8' }, toFailure: false, note: 'Stand on a bumper plate. Focus on getting a big stretch and touch your stomach/chest on each rep.' },
        { name: 'Overhead Cable Triceps Extension (Bar)', sub1: 'Overhead Cable Triceps Extension (Rope)', sub2: 'DB Skull Crusher', reps: '8-10', rest: '1-2 min', warmupSets: 1, earlyRPE: { wk12: '~7', wk35: '~7' }, lastRPE: { wk12: '~7', wk35: '~8' }, toFailure: false, note: 'Optionally pause for 0.5-1 second in the stretched aspect of each rep.' },
        { name: 'Bayesian Cable Curl', sub1: 'Seated Super-Bayesian High Cable Curl', sub2: 'Incline DB Stretch Curl', reps: '8-10', rest: '1-2 min', warmupSets: 1, earlyRPE: { wk12: '~7', wk35: '~7' }, lastRPE: { wk12: '~7', wk35: '~8' }, toFailure: false, note: 'If you have a left-right bicep imbalance, do these one arm at a time starting with the weaker arm, then match reps on the stronger. No imbalance? Do both arms together.' },
      ]},
      Lower: { focus: 'Strength Focus', exercises: [
        { name: 'Lying Leg Curl', sub1: 'Seated Leg Curl', sub2: 'Nordic Ham Curl', reps: '8-10', rest: '1-2 min', warmupSets: 2, earlyRPE: { wk12: '~7', wk35: '~7' }, lastRPE: { wk12: '~7', wk35: '~8' }, toFailure: false, note: 'Set the machine for the biggest stretch at the bottom. Prevent your butt from popping up as you curl.' },
        { name: 'Smith Machine Squat', sub1: 'DB Bulgarian Split Squat', sub2: 'High-Bar Back Squat', reps: '6-8', rest: '3-5 min', warmupSets: 4, earlyRPE: { wk12: '~6', wk35: '~7' }, lastRPE: { wk12: '~6', wk35: '~7' }, toFailure: false, note: 'Feet set as a normal squat, then brought forward 3-6 inches for a more upright posture and quad tension. If heels raise, bring feet more forward. If your lower back rounds, bring feet back.' },
        { name: 'Barbell RDL', sub1: 'DB RDL', sub2: 'Snatch-Grip RDL', reps: '6-8', rest: '2-3 min', warmupSets: 3, earlyRPE: { wk12: '~6', wk35: '~7' }, lastRPE: { wk12: '~6', wk35: '~7' }, toFailure: false, note: 'Stop about 75% of the way to full lockout each rep — stay in the bottom 3/4 of ROM to keep tension on the hamstrings.' },
        { name: 'Leg Extension', sub1: 'Reverse Nordic', sub2: 'Sissy Squat', reps: '8-10', rest: '1-2 min', warmupSets: 2, earlyRPE: { wk12: '~7', wk35: '~7' }, lastRPE: { wk12: '~7', wk35: '~8' }, toFailure: false, note: 'Seat back as far as comfortable. Grab the handles to pull your butt down into the seat. Use a 2-3 second negative and feel your quads pulling apart.' },
        { name: 'Standing Calf Raise', sub1: 'Seated Calf Raise', sub2: 'Leg Press Calf Press', reps: '8-10', rest: '1-2 min', warmupSets: 2, earlyRPE: { wk12: '~7', wk35: '~7' }, lastRPE: { wk12: '~7', wk35: '~8' }, toFailure: false, note: '1-2 second pause at the bottom. Roll your ankle back and forth on the balls of your feet.' },
        { name: 'Cable Crunch', sub1: 'Decline Weighted Crunch', sub2: 'Machine Crunch', reps: '8-10', rest: '1-2 min', warmupSets: 1, earlyRPE: { wk12: '~7', wk35: '~7' }, lastRPE: { wk12: '~7', wk35: '~8' }, toFailure: false, note: 'Round your lower back as you crunch. Mind-muscle connection with your 6-pack.' },
      ]},
      Pull: { focus: 'Hypertrophy Focus', exercises: [
        { name: 'Neutral-Grip Lat Pulldown', sub1: 'Neutral-Grip Pull-Up', sub2: 'Dual-Handle Lat Pulldown', reps: '8-10', rest: '2-3 min', warmupSets: 3, earlyRPE: { wk12: '~6', wk35: '~7' }, lastRPE: { wk12: '~7', wk35: '~7' }, toFailure: false, note: 'Pull with the handle more out in front of you — a cross between a pullover and a pulldown. Feel your lats working more than the weight.' },
        { name: 'Chest-Supported Machine Row', sub1: 'Chest-Supported T-Bar Row', sub2: 'Incline Chest-Supported DB Row', reps: '8-10', rest: '2-3 min', warmupSets: 3, earlyRPE: { wk12: '~6', wk35: '~7' }, lastRPE: { wk12: '~7', wk35: '~7' }, toFailure: false, note: 'Flare your elbows out at roughly 45° and squeeze your shoulder blades together hard at the top of each rep.' },
        { name: '1-Arm 45° Cable Rear Delt Flye', sub1: 'Rope Face Pull', sub2: 'Reverse Pec Deck', reps: '10-12', rest: '1-2 min', warmupSets: 2, earlyRPE: { wk12: '~7', wk35: '~7' }, lastRPE: { wk12: '~7', wk35: '~8' }, toFailure: false, note: 'Pause for 1-2 seconds in the squeeze of each rep. Contract the rear delts hard!' },
        { name: 'Machine Shrug', sub1: 'Cable Paused Shrug-In', sub2: 'DB Shrug', reps: '10-12', rest: '1-2 min', warmupSets: 3, earlyRPE: { wk12: '~6', wk35: '~7' }, lastRPE: { wk12: '~7', wk35: '~7' }, toFailure: false, note: 'Brief pause at the top and bottom of ROM. Think about pulling your shoulders up to your ears.' },
        { name: 'EZ-Bar Cable Curl', sub1: 'EZ-Bar Curl', sub2: 'DB Curl', reps: '10-12', rest: '1-2 min', warmupSets: 1, earlyRPE: { wk12: '~7', wk35: '~7' }, lastRPE: { wk12: '~7', wk35: '~8' }, toFailure: false, note: 'Set up the cable at the lowest position. Maintain constant tension on the biceps. Slow, controlled reps.' },
        { name: 'Machine Preacher Curl', sub1: 'EZ-Bar Preacher Curl', sub2: 'DB Preacher Curl', reps: '12-15', rest: '1-2 min', warmupSets: 1, earlyRPE: { wk12: '~7', wk35: '~7' }, lastRPE: { wk12: '~7', wk35: '~8' }, toFailure: false, note: 'Smooth, controlled reps. Mind-muscle connection with the biceps.' },
      ]},
      Push: { focus: 'Hypertrophy Focus', exercises: [
        { name: 'Barbell Bench Press', sub1: 'Machine Chest Press', sub2: 'DB Bench Press', reps: '8-10', rest: '3-5 min', warmupSets: 4, earlyRPE: { wk12: '~6', wk35: '~7' }, lastRPE: { wk12: '~6', wk35: '~7' }, toFailure: false, note: 'Set up a comfortable arch, quick pause on the chest, and explode up on each rep.' },
        { name: 'Machine Shoulder Press', sub1: 'Cable Shoulder Press', sub2: 'Seated DB Shoulder Press', reps: '8-10', rest: '2-3 min', warmupSets: 3, earlyRPE: { wk12: '~6', wk35: '~7' }, lastRPE: { wk12: '~6', wk35: '~7' }, toFailure: false, note: 'Ensure your elbows break at least 90°. Mind-muscle connection with your delts. Smooth, controlled reps.' },
        { name: 'Bottom-Half DB Flye', sub1: 'Bottom-Half Seated Cable Flye', sub2: 'Low-to-High Cable Crossover', reps: '10-12', rest: '1-2 min', warmupSets: 2, earlyRPE: { wk12: '~7', wk35: '~7' }, lastRPE: { wk12: '~7', wk35: '~8' }, toFailure: false, note: 'All reps and sets in the bottom half of the ROM. Feel a deep stretch in your pecs at the bottom of each rep.' },
        { name: 'High-Cable Lateral Raise', sub1: 'High-Cable Cuffed Lateral Raise', sub2: 'Lean-In DB Lateral Raise', reps: '10-12', rest: '1-2 min', warmupSets: 1, earlyRPE: { wk12: '~7', wk35: '~7' }, lastRPE: { wk12: '~7', wk35: '~8' }, toFailure: false, note: 'Focus on squeezing your lateral delt to move the weight.' },
        { name: 'Overhead Cable Triceps Extension (Bar)', sub1: 'Overhead Cable Triceps Extension (Rope)', sub2: 'DB Skull Crusher', reps: '10-12', rest: '1-2 min', warmupSets: 1, earlyRPE: { wk12: '~7', wk35: '~7' }, lastRPE: { wk12: '~7', wk35: '~8' }, toFailure: false, note: 'Optionally pause for 0.5-1 second in the stretched aspect of each rep.' },
        { name: 'Cable Triceps Kickback', sub1: 'DB Triceps Kickback', sub2: 'Bench Dip', reps: '12-15', rest: '1-2 min', warmupSets: 1, earlyRPE: { wk12: '~7', wk35: '~7' }, lastRPE: { wk12: '~7', wk35: '~8' }, toFailure: false, note: 'Upright or bent over — your choice. In the full squeeze, your shoulder should be back behind your torso.' },
        { name: 'Lying Leg Raise', sub1: 'Hanging Leg Raise', sub2: 'Modified Candlestick', reps: '10-20', rest: '1-2 min', warmupSets: 1, earlyRPE: { wk12: '~7', wk35: '~7' }, lastRPE: { wk12: '~7', wk35: '~8' }, toFailure: false, note: 'Perform these slowly. Keep your lower back against the ground throughout the set.' },
      ]},
      Legs: { focus: 'Hypertrophy Focus', exercises: [
        { name: 'Leg Press', sub1: 'Smith Machine Static Lunge', sub2: 'DB Walking Lunge', reps: '8-10', rest: '2-3 min', warmupSets: 4, earlyRPE: { wk12: '~6', wk35: '~7' }, lastRPE: { wk12: '~6', wk35: '~7' }, toFailure: false, note: 'Feet lower on the platform for more quad focus. Get as deep as possible without back rounding. Control the negative with a slight pause at the bottom.' },
        { name: 'Seated Leg Curl', sub1: 'Lying Leg Curl', sub2: 'Nordic Ham Curl', reps: '10-12', rest: '1-2 min', warmupSets: 2, earlyRPE: { wk12: '~7', wk35: '~7' }, lastRPE: { wk12: '~7', wk35: '~8' }, toFailure: false, note: 'Lean forward over the machine to get a maximum stretch in your hamstrings.' },
        { name: 'Walking Lunge', sub1: 'DB Step-Up', sub2: 'Goblet Squat', reps: '8-10', rest: '2-3 min', warmupSets: 3, earlyRPE: { wk12: '~6', wk35: '~7' }, lastRPE: { wk12: '~6', wk35: '~7' }, toFailure: false, note: 'Take medium strides. Minimize contribution from the back leg.' },
        { name: 'Machine Hip Abduction', sub1: 'Cable Hip Abduction', sub2: 'Lateral Band Walk', reps: '10-12', rest: '1-2 min', warmupSets: 2, earlyRPE: { wk12: '~7', wk35: '~7' }, lastRPE: { wk12: '~7', wk35: '~8' }, toFailure: false, note: 'Use pads to increase ROM if possible. Lean forward and grab the machine rails to stretch the glutes further.' },
        { name: 'Standing Calf Raise', sub1: 'Seated Calf Raise', sub2: 'Leg Press Calf Press', reps: '10-12', rest: '1-2 min', warmupSets: 2, earlyRPE: { wk12: '~7', wk35: '~7' }, lastRPE: { wk12: '~7', wk35: '~8' }, toFailure: false, note: '1-2 second pause at the bottom. Roll your ankle back and forth on the balls of your feet.' },
      ]},
    },

    ramping: {
      Upper: { focus: 'Strength Focus', exercises: [
        { name: '45° Incline DB Press', sub1: '45° Incline Barbell Press', sub2: '45° Incline Machine Press', reps: '8-10', rest: '3-5 min', warmupSets: 3, earlyRPE: { wk6: '~6', wk712: '~7-8' }, lastRPE: { wk6: '~6', wk712: '~7-8' }, toFailure: false, note: '1 second pause at the bottom of each rep while maintaining tension on the pecs.' },
        { name: 'Pec Deck', sub1: 'Cable Crossover Ladder', sub2: 'Bottom-Half DB Flye', reps: '10-12', rest: '1-2 min', warmupSets: 1, earlyRPE: { wk6: '~6', wk712: '~7-8' }, lastRPE: { wk6: '~7', wk712: '~8-9' }, toFailure: false, note: 'Focus on bringing your elbows together — not your hands.' },
        { name: 'Dual-Handle Lat Pulldown', sub1: 'Wide-Grip Lat Pulldown', sub2: 'Wide-Grip Pull-Up', reps: '10-12', rest: '2-3 min', warmupSets: 2, earlyRPE: { wk6: '~6', wk712: '~7-8' }, lastRPE: { wk6: '~6', wk712: '~7-8' }, toFailure: false, note: 'Lean back ~15° and drive your elbows down as you squeeze your shoulder blades together. Should feel like a mix of lats and mid-traps.' },
        { name: 'High-Cable Lateral Raise', sub1: 'High-Cable Cuffed Lateral Raise', sub2: 'Lean-In DB Lateral Raise', reps: '10-12', rest: '1-2 min', warmupSets: 1, earlyRPE: { wk6: '~6', wk712: '~8-9' }, lastRPE: { wk6: '~6', wk712: 'Failure' }, toFailure: true, note: 'Focus on squeezing your lateral delt to move the weight.' },
        { name: 'Smith Machine Row', sub1: 'Pendlay Deficit Row', sub2: 'Single-Arm DB Row', reps: '8-10', rest: '2-3 min', warmupSets: 2, earlyRPE: { wk6: '~6', wk712: '~7-8' }, lastRPE: { wk6: '~6', wk712: '~7-8' }, toFailure: false, note: 'Focus on squeezing your shoulder blades together, keeping your elbows at a ~45° angle.' },
        { name: 'Overhead Cable Triceps Extension (Bar)', sub1: 'Overhead Cable Triceps Extension (Rope)', sub2: 'DB Skull Crusher', reps: '10-12', rest: '1-2 min', warmupSets: 1, earlyRPE: { wk6: '~7', wk712: '~8-9' }, lastRPE: { wk6: '~7', wk712: 'Failure' }, toFailure: true, note: 'Optionally pause 0.5-1 second in the stretched aspect of each rep.' },
        { name: 'Bayesian Cable Curl', sub1: 'Seated Super-Bayesian High Cable Curl', sub2: 'Incline DB Stretch Curl', reps: '10-12', rest: '1-2 min', warmupSets: 1, earlyRPE: { wk6: '~7', wk712: '~8-9' }, lastRPE: { wk6: '~7', wk712: 'Failure' }, toFailure: true, note: 'If you have a left-right imbalance, start with the weaker arm and match reps on the stronger; otherwise do both arms together.' },
      ]},
      Lower: { focus: 'Strength Focus', exercises: [
        { name: 'Lying Leg Curl', sub1: 'Seated Leg Curl', sub2: 'Nordic Ham Curl', reps: '10-12', rest: '1-2 min', warmupSets: 2, earlyRPE: { wk6: '~7', wk712: '~7-8' }, lastRPE: { wk6: '~7', wk712: '~8-9' }, toFailure: false, note: 'Set the machine for the biggest stretch at the bottom. Prevent your butt from popping up as you curl.' },
        { name: 'Smith Machine Static Lunge (Elevated Front Foot)', sub1: 'DB Bulgarian Split Squat', sub2: 'High-Bar Back Squat', reps: '8-10', rest: '3-5 min', warmupSets: 4, earlyRPE: { wk6: '~6', wk712: '~7-8' }, lastRPE: { wk6: '~6', wk712: '~7-8' }, toFailure: false, note: 'Elevate your front foot on a small box. Minimize contribution from your back leg.' },
        { name: '45° Hyperextension', sub1: 'Glute-Ham Raise', sub2: 'Cable Pull-Through', reps: '8-10', rest: '2-3 min', warmupSets: 3, earlyRPE: { wk6: '~6', wk712: '~7-8' }, lastRPE: { wk6: '~6', wk712: '~7-8' }, toFailure: false, note: 'Squeeze your glutes hard at the top of each rep. Slow, controlled negative followed by an explosive positive.' },
        { name: 'Leg Extension', sub1: 'Reverse Nordic', sub2: 'Sissy Squat', reps: '10-12', rest: '1-2 min', warmupSets: 2, earlyRPE: { wk6: '~7', wk712: '~8-9' }, lastRPE: { wk6: '~7', wk712: 'Failure' }, toFailure: true, note: 'Seat back as far as comfortable. Grab the handles to pull your butt into the seat. Use a 2-3 second negative and feel your quads pulling apart.' },
        { name: 'Leg Press Calf Press', sub1: 'Seated Calf Raise', sub2: 'Standing Calf Raise', reps: '10-12', rest: '1-2 min', warmupSets: 2, earlyRPE: { wk6: '~7', wk712: '~8-9' }, lastRPE: { wk6: '~7', wk712: 'Failure' }, toFailure: true, note: '1-2 second pause at the bottom. Roll your ankle back and forth on the balls of your feet.' },
        { name: 'Machine Crunch', sub1: 'Decline Weighted Crunch', sub2: 'Cable Crunch', reps: '10-12', rest: '1-2 min', warmupSets: 1, earlyRPE: { wk6: '~7', wk712: '~8-9' }, lastRPE: { wk6: '~7', wk712: 'Failure' }, toFailure: true, note: 'Round your lower back as you crunch. Mind-muscle connection with your 6-pack.' },
      ]},
      Pull: { focus: 'Hypertrophy Focus', exercises: [
        { name: 'Lean-Back Lat Pulldown', sub1: 'Lean-Back Machine Pulldown', sub2: 'Pull-Up', reps: '10-12', rest: '2-3 min', warmupSets: 3, earlyRPE: { wk6: '~6', wk712: '~7-8' }, lastRPE: { wk6: '~6', wk712: '~7-8' }, toFailure: false, note: 'Initiate the pulldown with a straight, upright posture. As you pull the bar down, lean back 15-30° to get the mid-back more involved. Softly touch the bar to your chest every rep and control the weight even while leaning back.' },
        { name: 'Chest-Supported T-Bar Row', sub1: 'Chest-Supported Machine Row', sub2: 'Incline Chest-Supported DB Row', reps: '10-12', rest: '2-3 min', warmupSets: 3, earlyRPE: { wk6: '~6', wk712: '~8-9' }, lastRPE: { wk6: '~6', wk712: 'Failure' }, toFailure: true, note: 'Flare your elbows out at roughly 45° and squeeze your shoulder blades together hard at the top.' },
        { name: '1-Arm 45° Cable Rear Delt Flye', sub1: 'Rope Face Pull', sub2: 'Reverse Pec Deck', reps: '12-15', rest: '1-2 min', warmupSets: 2, earlyRPE: { wk6: '~7', wk712: '~8-9' }, lastRPE: { wk6: '~7', wk712: 'Failure' }, toFailure: true, note: 'Pause 1-2 seconds in the squeeze of each rep. Contract the rear delts hard!' },
        { name: 'Cable Paused Shrug-In', sub1: 'Machine Shrug', sub2: 'DB Shrug', reps: '12-15', rest: '1-2 min', warmupSets: 3, earlyRPE: { wk6: '~6', wk712: '~7' }, lastRPE: { wk6: '~6', wk712: '~8-9' }, toFailure: false, note: "Shrug up and in — think 'up to your ears.' 1-2 second pause in the squeeze (top) and another 1-2 second pause in the stretch (bottom) of each rep." },
        { name: 'Cable Rope Hammer Curl', sub1: 'DB Hammer Curl', sub2: 'Hammer Preacher Curl', reps: '12-15', rest: '1-2 min', warmupSets: 1, earlyRPE: { wk6: '~7', wk712: '~7' }, lastRPE: { wk6: '~7', wk712: '~8-9' }, toFailure: false, note: 'Squeeze the rope hard as you curl the weight up. Smooth, controlled reps.' },
        { name: 'DB Concentration Curl', sub1: 'Concentration Cable Curl', sub2: 'DB Preacher Curl', reps: '15-20', rest: '1-2 min', warmupSets: 1, earlyRPE: { wk6: '~7', wk712: '~8-9' }, lastRPE: { wk6: '~7', wk712: 'Failure' }, toFailure: true, note: 'Smooth, controlled reps. Mind-muscle connection with the biceps.' },
      ]},
      Push: { focus: 'Hypertrophy Focus', exercises: [
        { name: 'Machine Chest Press', sub1: 'Barbell Bench Press', sub2: 'DB Bench Press', reps: '10-12', rest: '3-5 min', warmupSets: 4, earlyRPE: { wk6: '~6', wk712: '~7-8' }, lastRPE: { wk6: '~6', wk712: '~7-8' }, toFailure: false, note: '1 second pause at the bottom of each rep while maintaining tension on the pecs.' },
        { name: 'Seated DB Shoulder Press', sub1: 'Cable Shoulder Press', sub2: 'Machine Shoulder Press', reps: '10-12', rest: '2-3 min', warmupSets: 3, earlyRPE: { wk6: '~6', wk712: '~7-8' }, lastRPE: { wk6: '~6', wk712: '~7-8' }, toFailure: false, note: 'Ensure your elbows break at least 90°. Mind-muscle connection with your delts. Smooth, controlled reps.' },
        { name: 'Bottom-Half Seated Cable Flye', sub1: 'Bottom-Half DB Flye', sub2: 'Low-to-High Cable Crossover', reps: '12-15', rest: '1-2 min', warmupSets: 2, earlyRPE: { wk6: '~7', wk712: '~8-9' }, lastRPE: { wk6: '~7', wk712: 'Failure' }, toFailure: true, note: 'All reps and sets in the bottom half of the ROM. Feel a deep stretch in your pecs at the bottom of each rep.' },
        { name: 'High-Cable Lateral Raise', sub1: 'High-Cable Cuffed Lateral Raise', sub2: 'Lean-In DB Lateral Raise', reps: '12-15', rest: '1-2 min', warmupSets: 1, earlyRPE: { wk6: '~7', wk712: '~8-9' }, lastRPE: { wk6: '~7', wk712: 'Failure' }, toFailure: true, note: 'Focus on squeezing your lateral delt to move the weight.' },
        { name: 'EZ-Bar Skull Crusher', sub1: 'DB Skull Crusher', sub2: 'Katana Triceps Extension', reps: '12-15', rest: '1-2 min', warmupSets: 1, earlyRPE: { wk6: '~7', wk712: '~8-9' }, lastRPE: { wk6: '~7', wk712: 'Failure' }, toFailure: true, note: 'Optionally pause for 0.5-1 second in the stretched aspect of each rep.' },
        { name: 'Triceps Pressdown (Bar)', sub1: 'Triceps Pressdown (Rope)', sub2: 'DB Triceps Kickback', reps: '15-20', rest: '1-2 min', warmupSets: 1, earlyRPE: { wk6: '~7', wk712: '~8-9' }, lastRPE: { wk6: '~7', wk712: 'Failure' }, toFailure: true, note: 'Focus on squeezing your triceps to move the weight.' },
        { name: 'Ab Wheel Rollout', sub1: 'Swiss Ball Rollout', sub2: 'Long-Lever Plank', reps: '12-15', rest: '1-2 min', warmupSets: 2, earlyRPE: { wk6: '~7', wk712: '~8-9' }, lastRPE: { wk6: '~7', wk712: 'Failure' }, toFailure: true, note: "Don't just bend at your hips — use your abs to lower yourself under control and pull yourself back up. If you can't get fully extended at the bottom, progressively increase the ROM week to week." },
      ]},
      Legs: { focus: 'Hypertrophy Focus', exercises: [
        { name: 'Hack Squat', sub1: 'Leg Press', sub2: 'DB Walking Lunge', reps: '10-12', rest: '2-3 min', warmupSets: 4, earlyRPE: { wk6: '~6', wk712: '~7-8' }, lastRPE: { wk6: '~6', wk712: '~7-8' }, toFailure: false, note: 'Use a controlled negative (don\'t free fall) and then explode on the positive.' },
        { name: 'Seated Leg Curl', sub1: 'Lying Leg Curl', sub2: 'Nordic Ham Curl', reps: '12-15', rest: '1-2 min', warmupSets: 2, earlyRPE: { wk6: '~7', wk712: '~7-8' }, lastRPE: { wk6: '~7', wk712: '~8-9' }, toFailure: false, note: 'Lean forward over the machine to get a maximum stretch in your hamstrings.' },
        { name: 'Walking Lunge', sub1: 'Smith Machine Static Lunge', sub2: 'DB Static Lunge', reps: '10-12', rest: '2-3 min', warmupSets: 3, earlyRPE: { wk6: '~6', wk712: '~7-8' }, lastRPE: { wk6: '~6', wk712: '~7-8' }, toFailure: false, note: 'Take medium strides. Minimize contribution from the back leg.' },
        { name: 'Machine Hip Abduction', sub1: 'Cable Hip Abduction', sub2: 'Lateral Band Walk', reps: '12-15', rest: '1-2 min', warmupSets: 2, earlyRPE: { wk6: '~7', wk712: '~8-9' }, lastRPE: { wk6: '~7', wk712: 'Failure' }, toFailure: true, note: 'Use pads to increase ROM if possible. Lean forward and grab the machine rails to stretch the glutes further.' },
        { name: 'Standing Calf Raise', sub1: 'Seated Calf Raise', sub2: 'Leg Press Calf Press', reps: '12-15', rest: '1-2 min', warmupSets: 2, earlyRPE: { wk6: '~7', wk712: '~8-9' }, lastRPE: { wk6: '~7', wk712: 'Failure' }, toFailure: true, note: '1-2 second pause at the bottom. Roll your ankle back and forth on the balls of your feet.' },
      ]},
    },
